...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            url: `http://localhost:5500/restaurants/${restId}`,
            method: 'get',
            headers: { 'Content-Type': 'application/JSON' }
        })
            .then(res => {
                this.setState({ restaurant: res.data.restaurants, resId: restId })
            })
            ...
            <div>
                ...
                <div className="container">
                    <div className="bannerCover">
                        <img className="banner" src={restaurant.thumb} alt="" />
                ...
                >
                    ...
                    <div>
                        <Carousel showIndicators={false} showThumbs={false} showStatus={false}>
                            <div>
                                <img src={restaurant.thumb} alt="" className="gallery_img" />
                            </div>
                        </Carousel>
                    </div>
                </Modal>
                ...
                >
                    ...
                    <div style={{ width: '20em' }}>
                        ...
                        <button className="btn btn-danger" style={{ float: "right", marginTop: "18px" }} onClick={this.handlePayment}>
