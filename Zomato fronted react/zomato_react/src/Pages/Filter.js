...
class Filter extends React.Component {
    ...
    handleLocation = (val) => {
        ...
        axios({
            ...
            .then(res => {
                this.setState({ restaurant: res.data.restaurants, loca })//fetching data-this.state     editing/updating data-this.setState
            })
            .catch((err => console.log(err)))
    ...
    handleCuisine = (i) => {
        ...
        axios({
            ...
            .then(res => {
                this.setState({ restaurant: res.data.restaurants, Cuisine: tempCuisine })//fetching data-this.state     editing/updating data-this.setState
            })
            .catch((err => console.log(err)))
    ...
    render() {
        const { location, restaurant,mealt } = this.state;
        return (
            <div>
                {/* <!--Navbar--> */}
